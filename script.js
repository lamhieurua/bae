...
// --- Love Notes Database (Siêu cấp ngọt ngào & dí dỏm) ---
const loveNotes = [
  "Bản cập nhật cuộc đời anh: Từ ngày có em, mọi lỗi lầm của thế giới này đều được tha thứ hết trơn! 🚀💕",
  "Nếu dễ thương là một tội danh, chắc em đã bị tuyên án chung thân trong tim anh mất gòii! 👮‍♂️🔒",
  "Ngoài kia bão táp mưa sa, nếu mệt mỏi quá thì về bên anh, vòng tay này luôn sẵn sàng ôm lấy em nè! 🏡✨",
  "Anh không giỏi làm thơ, nhưng làm em cười mỗi ngày thì anh tự tin 100 điểm không có nhưng! 💯🥰",
  "Trái tim anh rộng rãi lắm, nhưng từ ngày em bước vào thì em chiếm trọn spotlight luôn gòii! 🌟",
  "Người ta thích ngắm sao trời, còn anh chỉ thích ngắm cô bé má phúng phính trong ảnh Polaroid thui! 👀💖",
  "Hôm nay em có thấy mỏi chân hơm? Chạy lòng vòng trong tâm trí anh cả ngày rồi đó nha! 🏃‍♀️💨",
  "Sau này dù lưng có còng răng có rụng, anh vẫn sẽ là 'chân sai vặt' trung thành nhất của em! 👵👴💍"
];
let currentNoteIndex = 0;

// --- Dodge Button Phrases (Hài hước, lầy lội, cưng xỉu) ---
const dodgePhrases = [
  "Hổng cho từ chối đou nha! 😝",
  "Nút này bị liệt rùi, bấm nút đỏ đi nè! 💖",
  "Bắt hụt gòii! Ai cho bấm nút này! 🏃‍♂️💨",
  "Từ chối là bị phạt 100 cái thơm má đó! 😚",
  "Cả vũ trụ đang bảo em bấm 'Đồng Ý' kìa! ✨",
  "Đừng chạy nữa mà, tim anh sắp rớt ra ngoài gòii! 🥺",
  "Bấm nút 'Đồng ý' đi mà bé iu ơiii! 💕"
];
let dodgeCount = 0;
